...
const WhyChooseComp = ({ data: { title, info } }) => {
  return (
    <div
      className={`bg-mediumBlue/50 ${styles.flexCol} justify-end items-center gap-3 pt-4 md:pt-0 md:gap-4 px-2 pb-5 md:px-4 md:pb-8 text-center w-full text-white h-[250px] md:h-[420px] lg:h-[536px]`}
    >
