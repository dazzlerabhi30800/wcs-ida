...
const Footer = () => {
  return (
    <footer
      className={`${styles.marginT} bg-gradient-to-b from-transparent from-35% to-blue to-35%`}
    >
        ...
        >
          <div className={`${styles.flexCol} flex-1 gap-6`}>
            ...
            <Para1 fontWeight="font-normal">
              Lorem ipsum dolor sit amet consectetur. Lobortis in integer lorem
              malesuada in pretium vitae imperdiet vivamus. Lorem.
            </Para1>
          </div>
          <form
